...
<div class="mb-6 bg-base-200/50 p-4 rounded-2xl border border-base-200">
    ...
    <div class="flex gap-2 relative">
        <div class="relative w-full flex items-center">
            <input type="text" bind:value={aiQuestion} placeholder="e.g. What kind of batteries does this take?" class="input input-sm input-bordered w-full rounded-xl pr-20 {hasPhotos ? 'pl-24' : 'pl-4'}" on:keydown={(e) => e.key === 'Enter' && askAiQuestion()} disabled={isAskingAi} />
